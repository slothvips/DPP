/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 45813f0a7e747732a97a1863c4becfde)
// Runtime types generated with workerd@1.20260210.0 2025-01-01
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SyncPushCoordinator";
	}
	interface TestEnv {
		DB: D1Database;
		SYNC_PUSH_COORDINATOR: DurableObjectNamespace<import("./src/index").SyncPushCoordinator>;
	}
	interface Env {
		DB: D1Database;
		SYNC_PUSH_COORDINATOR: DurableObjectNamespace<import("./src/index").SyncPushCoordinator>;
