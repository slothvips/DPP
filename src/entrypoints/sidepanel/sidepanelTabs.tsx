      ...
      sections: [
        {
          ...
          items: [
            ...
            '密钥、算法、位数、周期导入后不可修改；未配置个人私钥时数据仅保存在本机。',
            '可设置 PIN：离开验证器、隐藏侧边栏或空闲超时后自动锁屏，需输入 PIN 才能查看。',
            'PIN 无法找回；遗忘时需验证个人私钥，或（未配置私钥时）删除全部账户后才能重置。',
          ],
        },
        {
          title: '导入 / 导出',
          items: [
            '导入：扫描当前网页二维码，或粘贴 otpauth:// 链接 / Base32 密钥，支持批量。',
            '导出：勾选账户后复制或下载 otpauth:// 文本，默认不展示明文。完成迁移后请尽快删除明文备份并清理剪贴板，防止泄露。',
          ],
        },
