...
interface BaseSettingMap {
  ...
  jenkins_workbench_v2: boolean;
  jenkins_queue: boolean;
  jenkins_build_lifecycle: boolean;
  jenkins_full_log: boolean;
  jenkins_pipeline_features: boolean;
  jenkins_artifacts: boolean;
  jenkins_ai_actions: boolean;
  ...
  jenkins_recent_jobs: Array<{ envId: string; url: string; name: string; at: number }>;
